...
export const Route = createFileRoute("/json-table")({
  component: RouteComponent,
  staticData: {
    title: "JSON Table Viewer",
    sidebar: {
      label: "JSON Table Viewer",
    ...
    <div className="flex flex-col h-full rounded-xl">
      ...
      >
        <ResizablePanel
          ...
          minSize={300}
          onResize={() =>
            setisInputCollapsed(leftPanelRef.current?.isCollapsed ?? false)
          }
        >
          <CodeEditor
        ...
        <ResizableHandle />
        <ResizablePanel minSize={300} className="overflow-hidden">
          <JSONGrid
            data={
